...
WebUI.verifyElementPresent(findTestObject('Page_Overview/a_Agent Summary'), 0)

WebUI.verifyElementClickable(findTestObject('Page_Overview/a_Agent Summary'))

WebUI.verifyElementPresent(findTestObject('Page_Overview/a_Agent Details'), 0)

WebUI.verifyElementClickable(findTestObject('Page_Overview/a_Agent Details'))

WebUI.verifyElementPresent(findTestObject('Page_Overview/a_Event Analyzer'), 0)

WebUI.verifyElementClickable(findTestObject('Page_Overview/a_Event Analyzer'))
...
WebUI.navigateToUrl('https://stats.eu1.kontiki.com/dashboards/analytics_external::live_event?content_moid_filter=70ec1679-4494-492d-a492-bd4440e0ee3d&time_filter=&filter_config=%7B%22content_moid_filter%22:%5B%7B%22type%22:%22%3D%22,%22values%22:%5B%7B%22constant%22:%2270ec1679-4494-492d-a492-bd4440e0ee3d%22%7D,%7B%7D%5D,%22id%22:0%7D%5D,%22time_filter%22:%5B%7B%22type%22:%22advanced%22,%22values%22:%5B%7B%22constant%22:null%7D,%7B%7D%5D,%22id%22:1%7D%5D%7D')

WebUI.waitForPageLoad(90)

WebUI.waitForAngularLoad(120)

WebUI.verifyElementPresent(findTestObject('Page_Live Event/a_Go to Geo Explorer'), 0)

WebUI.verifyElementPresent(findTestObject('Page_Live Event/a_Go to Event Analyzer'), 0)
