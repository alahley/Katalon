...
WebUI.verifyElementClickable(findTestObject('Page_Overview/a_Configuration Manager Summar'))

WebUI.click(findTestObject('Page_Overview/a_Configuration Manager Summar'))
