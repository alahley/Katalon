...
WebUI.verifyElementClickable(findTestObject('Page_Overview/a_Event Analyzer'), FailureHandling.CONTINUE_ON_FAILURE)
...
not_run: WebUI.click(findTestObject('Page_Overview/a_Network'))
