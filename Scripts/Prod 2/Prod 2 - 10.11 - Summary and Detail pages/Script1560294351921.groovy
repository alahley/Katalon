...
'Waits for all angular elements on the Overview landing page to load in 60 seconds or less\n'
...
'Waits for all angular elements on the Summary page to load in 60 seconds or less\n'
WebUI.waitForAngularLoad(60)
