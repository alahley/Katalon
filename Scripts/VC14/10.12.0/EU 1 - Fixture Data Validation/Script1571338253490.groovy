...
WebUI.setText(findTestObject('Page_Overview/input_Time Filter_form-control'), '2018')
...
WebUI.verifyElementText(findTestObject('Page_Overview/div_4465'), '4,465')
...
WebUI.verifyElementText(findTestObject('Page_Overview/div_443'), '443')
...
WebUI.verifyElementText(findTestObject('Page_Overview/div_1198510'), '1,198,510')
...
WebUI.verifyElementText(findTestObject('Page_Overview/div_99876'), '99,876')
...
WebUI.verifyElementText(findTestObject('Page_Overview/div_24893'), '24,893')

'Verify Total Views widget exists on page'
WebUI.verifyElementText(findTestObject('Page_Overview/div_Views'), 'Views')

'FIXTURE DATA - Verify Total views widget has a value of 17,443'
WebUI.verifyElementText(findTestObject('Page_Overview/div_2375653'), '2,375,653')
...
WebUI.verifyElementText(findTestObject('Page_Overview/div_309945'), '309,945')
...
WebUI.verifyElementText(findTestObject('Page_Overview/div_158825.3'), '158,825.3')

'Verify Unique Agent widget exists on page'
WebUI.verifyElementText(findTestObject('Page_Overview/div_Agents'), 'Agents')

'FIXTURE DATA - Verify Unique Agents widget has a value of 10,905'
WebUI.verifyElementText(findTestObject('Page_Overview/div_2322620'), '2,322,620')
...
WebUI.verifyElementText(findTestObject('Page_Overview/div_8295491'), '8,295,491')
...
WebUI.verifyElementText(findTestObject('Page_Overview/div_353757'), '353,757')
...
WebUI.verifyElementText(findTestObject('Page_Overview/div_451094.66'), '451,094.66')
...
not_run: WebUI.verifyElementPresent(findTestObject('Page_Overview/div_82'), 82)
