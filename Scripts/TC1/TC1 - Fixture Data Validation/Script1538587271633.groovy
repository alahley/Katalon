...
WebUI.verifyElementText(findTestObject('Page_Overview/div_14388'), '14,388')
...
WebUI.verifyElementText(findTestObject('Page_Overview/div_11413 (1)'), '11,413')
...
WebUI.verifyElementText(findTestObject('Page_Overview/div_1404.1 (1)'), '1,404.1')
...
WebUI.verifyElementText(findTestObject('Page_Overview/div_67512'), '67,512')
...
WebUI.verifyElementText(findTestObject('Page_Overview/div_1573'), '1,573')
...
WebUI.verifyElementText(findTestObject('Page_Overview/div_3865.08 (1)'), '3,865.08')
...
WebUI.navigateToUrl('https://stats.tc1.kontiki.com/admin/users?sorts=last_name%20asc&name=demo')
