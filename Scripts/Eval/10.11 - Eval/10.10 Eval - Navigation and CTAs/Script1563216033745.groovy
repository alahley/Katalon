...
WebUI.verifyElementClickable(findTestObject('Page_Overview/a_Agent Summary'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Page_Agent Summary/a_Agent Details'), 0)

WebUI.verifyElementClickable(findTestObject('Page_Agent Summary/a_Agent Details'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Page_Agent/a_Event Analyzer'), 0)

WebUI.verifyElementClickable(findTestObject('Page_Agent/a_Event Analyzer'), FailureHandling.CONTINUE_ON_FAILURE)
